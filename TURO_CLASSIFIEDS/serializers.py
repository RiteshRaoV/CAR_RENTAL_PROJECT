...
class ListingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Listing
        fields = ['id', 'thumbnail', 'listing_date', 'mileage',
                  'price', 'ad_status', 'condition', 'description', 'vehicle']
        ...
        if listing:
            ...
            if request_price >= original_price:
                raise serializers.ValidationError(
                    "Request price must be less than the original listing price.")
...
class SellerProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = ['profile_picture', 'email', 'contact_number', 'address']
